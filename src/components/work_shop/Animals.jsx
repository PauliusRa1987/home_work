// Užduotis. Išrenderinti visus gyvūnus. Pernaudojant vieną komponentą Animal.
//Komponentas Animal turi per props atvaizduoti atitinkamą gyvūno pavadinimą (kaip figcaption) ir nuotrauką, img alt atributas turi rašytis tokiu formatu (pvz. alt="Hippo-animal").
//Extra užduotis figcaption fono spalva turi būti random sugeneruotos spalvos
...
function Animals() {
   return(
       <>
       {animals.map((animal) =>( <Animal key={animal.id} name={animal.animal} image={animal.img}/>))}
       </>
   )
}
